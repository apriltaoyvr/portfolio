...
export default function Home() {
  return (
    <main className='pt-8 flex flex-col place-content-center place-items-center'>
      <div className='flex flex-col place-content-center place-items-center justify-around gap-4 max-w-[80%] p-4 '>
        <header className='flex place-content-center w-full'>
          <div className='bg-background/70 border rounded-lg border-divider backdrop-blur-lg flex md:flex-row flex-col flex-wrap place-content-center place-items-start gap-4 p-8 max-h-fit'>
            ...
            <article className='flex flex-col place-content-start text-justify leading-12 gap-2 max-w-sm p-2'>
              <h2>About Me</h2>
              <p>Hey, I&apos;m <strong className='text-primary'>April</strong>!</p>
